  ...
  return (    
    <>
        <div className='bg-[#6b9122] grid sm:grid-cols-4 gap-4 sm:justify-items-center py-10 px-6 sm:py-40 sm:px-20'>
            ...
            <h4 className='font-bold uppercase mb-4 text-white'>Company</h4>
            ...
            <div className=''>
            <h4 className='font-bold uppercase text-white mb-4'>Site Map</h4>
            ...
            <div className=''>
            <h4 className='font-bold uppercase text-white mb-4'>About Us</h4>
            ...
            <div className='bg-[#6b9122] text-white relative text-center pt-4'>
