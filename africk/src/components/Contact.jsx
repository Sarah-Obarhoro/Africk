    ...
    <div className="mb-16" id="contact">
      ...
      <div className="grid md:grid-cols-3 sm:grid-cols-1 mr-20 ml-10 mt-20 gap-10">
        <div className="col-span-2">
          <form className="w-full" target="_blank" action="https://getform.io/f/a98579d1-4911-4c32-9920-be2a66d5f414" method="post" encType='muliport/form-data' >
            <div className="flex flex-wrap -mx-3 mb-6">
              <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                ...
                <input
                  ...
                  id="grid-full-name" type="text" name="name" required onChange={handleChange} value={data.name} />
              </div>
              ...
              <div className="w-full md:w-1/3 px-3 mt-8">
                ...
                <input
                  className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                  id="grid-phone" type="tel" name="phone" onChange={handleChange} value={data.phone} />
              </div>
            ...
            <button type="submit" className="bg-[#6b9122] w-full rounded py-3 px-6 text-white font-bold">Send Message</button>
          </form>
        </div>
