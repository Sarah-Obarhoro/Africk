...
const Partners = () => {
  return (
    <div className='justify-center content-center grid grid-rows-2 py-9'>
        <div className='mb-16'>
            <h1 className='mt-16  w-full justify-center text-[#6b9122] text-2xl uppercase font-bold' id='partners'>Our Partners</h1>
        </div>
